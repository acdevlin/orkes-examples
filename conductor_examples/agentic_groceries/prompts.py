...
RECIPE_FINDER_BBC_PROMPT_TEXT = _recipe_finder_prompt("BBC Food", "find_bbc_recipes")

RECIPE_FINDER_THYMEOUT_PROMPT_TEXT = _recipe_finder_prompt("ThymeOut", "find_thymeout_recipes")
